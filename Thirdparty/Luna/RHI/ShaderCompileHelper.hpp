...
namespace Luna
{
    namespace RHI
    {
        ...
        inline ShaderCompiler::TargetFormat get_current_platform_shader_target_format()
        {
            ...
            switch (api_type)
            {
                case BackendType::d3d12: return ShaderCompiler::TargetFormat::dxil;
                case BackendType::vulkan: return ShaderCompiler::TargetFormat::spir_v;
                case BackendType::metal: return ShaderCompiler::TargetFormat::msl;
            }
            lupanic();
        ...
        inline ShaderData get_shader_data_from_compile_result(const ShaderCompiler::ShaderCompileResult &compile_result)
        {
            ...
            switch (compile_result.format)
            {
                ...
                case ShaderCompiler::TargetFormat::none: break;
            }
            return r;
        }
        ...
        inline void fill_compute_pipeline_state_desc_from_compile_result(
            ComputePipelineStateDesc                  &desc,
            const ShaderCompiler::ShaderCompileResult &compile_result)
        {
