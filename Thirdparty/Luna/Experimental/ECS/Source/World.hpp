...
namespace Luna
{
    namespace ECS
    {
        ...
        struct EntityIdAllocator
        {
                ...
                EntityIdAllocator() : m_next_free_slot(0) {}
        ...
        struct ClusterType
        {
                ...
                {
                    return (components.size() == rhs.components.size()) && (tags.size() == rhs.tags.size())
        ...
        struct World: public IWorld
        {
                ...
                World() : m_last_exclusive_task(JobSystem::INVALID_JOB_ID)
                {
                ...
                Cluster      *get_cluster(Span<const typeinfo_t>  components,
                                          Span<const entity_id_t> tags,
    ...
    template <> struct hash<ECS::ClusterType>
    {
