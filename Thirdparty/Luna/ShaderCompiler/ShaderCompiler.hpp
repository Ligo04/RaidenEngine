...
namespace Luna
{
    namespace ShaderCompiler
    {
        ...
        //! ShaderCompiler is designed to work with RHI, but it can also be used independently to implement shader
        //! compile command-line tools without importing RHI module.
        //! @{
        ...
        struct ShaderCompileParameters
        {
                ...
                //! This will be used by the compiler or debugger to resolve local include file and PDB file if not
                //! empty.
        ...
        struct ShaderCompileResult
        {
                ...
                //! @details This should be used instead of @ref ShaderCompileParameters::entry_point when specifying
                //! entry point in RHI APIs, since the compiler may marshall function names in source files, the entry
                //! point name may change before and after compilation.
                Name entry_point;
                //! The number of threads for one thread group in X dimension.
                //! @details This is used only when the compile target is @ref TargetFormat::msl, since MSL does not
                //! record this in shader code.
