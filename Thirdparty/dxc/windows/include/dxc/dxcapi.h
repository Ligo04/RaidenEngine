...
extern "C" DXC_API_IMPORT
    HRESULT __stdcall DxcCreateInstance(_In_ REFCLSID rclsid, _In_ REFIID riid, _Out_ LPVOID *ppv);

extern "C" DXC_API_IMPORT HRESULT __stdcall DxcCreateInstance2(_In_ IMalloc *pMalloc,
                                                               _In_ REFCLSID rclsid,
                                                               _In_ REFIID   riid,
                                                               _Out_ LPVOID *ppv);
...
struct IDxcCompilerArgs: public IUnknown
{
        ...
        virtual HRESULT STDMETHODCALLTYPE AddArguments(_In_opt_count_(argCount)
            ...
            = 0;
        virtual HRESULT STDMETHODCALLTYPE
            AddArgumentsUTF8(_In_opt_count_(argCount) LPCSTR *pArguments, // Array of pointers to UTF-8 arguments to add
                             _In_ UINT32                      argCount    // Number of arguments to add
                             )
            = 0;
        virtual HRESULT STDMETHODCALLTYPE AddDefines(_In_count_(defineCount)
...
struct IDxcLibrary: public IUnknown
{
        ...
        virtual HRESULT STDMETHODCALLTYPE
            CreateBlobFromBlob(_In_ IDxcBlob *pBlob, UINT32 offset, UINT32 length, _COM_Outptr_ IDxcBlob **ppResult)
            = 0;
        virtual HRESULT STDMETHODCALLTYPE CreateBlobFromFile(_In_z_ LPCWSTR                  pFileName,
                                                             _In_opt_ UINT32                *codePage,
                                                             _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding)
            = 0;
        virtual HRESULT STDMETHODCALLTYPE
            CreateBlobWithEncodingFromPinned(_In_bytecount_(size) LPCVOID    pText,
                                             UINT32                          size,
                                             UINT32                          codePage,
                                             _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding)
            = 0;
        virtual HRESULT STDMETHODCALLTYPE
            CreateBlobWithEncodingOnHeapCopy(_In_bytecount_(size) LPCVOID    pText,
                                             UINT32                          size,
                                             UINT32                          codePage,
                                             _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding)
            = 0;
...
struct IDxcUtils: public IUnknown
{
        ...
        virtual HRESULT STDMETHODCALLTYPE CreateBlobFromPinned(_In_bytecount_(size) LPCVOID    pData,
                                                               UINT32                          size,
                                                               UINT32                          codePage,
                                                               _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding)
            = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE MoveToBlob(_In_bytecount_(size) LPCVOID    pData,
                                                     IMalloc                        *pIMalloc,
                                                     UINT32                          size,
                                                     UINT32                          codePage,
                                                     _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding)
        ...
        virtual HRESULT STDMETHODCALLTYPE CreateBlob(_In_bytecount_(size) LPCVOID    pData,
                                                     UINT32                          size,
                                                     UINT32                          codePage,
                                                     _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding)
            = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE LoadFile(_In_z_ LPCWSTR                  pFileName,
        ...
        virtual HRESULT STDMETHODCALLTYPE GetBlobAsUtf8(_In_ IDxcBlob *pBlob, _COM_Outptr_ IDxcBlobUtf8 **pBlobEncoding)
            = 0;

        // Renamed from GetBlobAsUtf16 to GetBlobAsWide
        virtual HRESULT STDMETHODCALLTYPE GetBlobAsWide(_In_ IDxcBlob *pBlob, _COM_Outptr_ IDxcBlobWide **pBlobEncoding)
            = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE CreateReflection(_In_ const DxcBuffer *pData,
                                                           REFIID                iid,
                                                           void                **ppvReflection)
            = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE GetPDBContents(_In_ IDxcBlob          *pPDBBlob,
...
struct IDxcResult: public IDxcOperationResult
{
        ...
        virtual HRESULT STDMETHODCALLTYPE GetOutput(_In_ DXC_OUT_KIND                        dxcOutKind,
                                                    ...
                                                    _COM_Outptr_ IDxcBlobWide              **ppOutputName)
            = 0;
...
struct IDxcExtraOutputs: public IUnknown
{
        ...
        virtual HRESULT STDMETHODCALLTYPE GetOutput(_In_ UINT32                                      uIndex,
                                                    ...
                                                    _COM_Outptr_opt_result_maybenull_ IDxcBlobWide **ppOutputName)
            = 0;
};
...
struct IDxcCompiler3: public IUnknown
{
        ...
        // Disassemble a program.
        virtual HRESULT STDMETHODCALLTYPE
            Disassemble(_In_ const DxcBuffer *pObject, // Program to disassemble: dxil container or bitcode.
                        _In_ REFIID           riid,
...
{
        virtual HRESULT STDMETHODCALLTYPE Load(_In_ IDxcBlob *pDxilContainerHeader)
            = 0;                                                              // Loads DxilContainer to the builder
        virtual HRESULT STDMETHODCALLTYPE AddPart(_In_ UINT32 fourCC, _In_ IDxcBlob *pSource)
            = 0;                                                              // Part to add to the container
        virtual HRESULT STDMETHODCALLTYPE RemovePart(_In_ UINT32 fourCC) = 0; // Remove the part with fourCC
        virtual HRESULT STDMETHODCALLTYPE SerializeContainer(_Out_ IDxcOperationResult **ppResult)
            = 0; // Builds a container of the given container builder state
};
...
struct IDxcPdbUtils2: public IUnknown
{
        ...
        virtual HRESULT STDMETHODCALLTYPE GetLibraryPDB(_In_ UINT32                                      uIndex,
                                                        _COM_Outptr_ IDxcPdbUtils2                     **ppOutPdbUtils,
                                                        _COM_Outptr_opt_result_maybenull_ IDxcBlobWide **ppLibraryName)
            = 0;
        ...
        virtual HRESULT STDMETHODCALLTYPE GetArgPair(_In_ UINT32                                  uIndex,
                                                     ...
                                                     _COM_Outptr_result_maybenull_ IDxcBlobWide **ppValue)
            = 0;
